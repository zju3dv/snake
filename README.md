...
1. Download the pretrained model [here](https://drive.google.com/drive/folders/140ifazuap3NVkSGbvH6yRsZ62mSheiFl?usp=sharing) and put it to `$ROOT/data/model/rcnn_snake/long_rcnn/197.pth`.
2. Test:
    ```
    # use coco evaluator
...
1. Download the pretrained model [here](https://drive.google.com/drive/folders/140ifazuap3NVkSGbvH6yRsZ62mSheiFl?usp=sharing) and put it to `$ROOT/data/model/snake/kins/149.pth`.
2. Test:
    ```
...
1. Download the pretrained model [here](https://drive.google.com/drive/folders/140ifazuap3NVkSGbvH6yRsZ62mSheiFl?usp=sharing) and put it to `$ROOT/data/model/snake/sbd/149.pth`.
2. Test:
    ```
